<template>
  <button
    @click="toggleTheme"
    class="flex items-center justify-center w-8 h-8 bg-[#3C3B6E] dark:bg-[#F1F1F1] rounded-full shadow-md hover:bg-[#3c3c90] dark:hover:bg-[#cfcece] transition-colors duration-300"  >
    <svg
      v-if="isDark"
